#!/usr/bin/env python3
"""Unit tests for deterministic Phase 8 analysis helpers."""
...
def load_analyzer():
    spec = importlib.util.spec_from_file_location("phase08_analysis", ANALYZER)
...
class Phase08AnalysisTests(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
