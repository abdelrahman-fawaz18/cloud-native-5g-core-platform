#!/usr/bin/env python3
"""Static safety and coverage tests for single-UE profile runtime validation."""
...
SCRIPT = ROOT / "scripts" / "validate-single-ue.sh"


class SingleUeProfileValidationStaticTests(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
