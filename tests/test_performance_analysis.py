...
ANALYZER = ROOT / "scripts" / "analyze-performance.py"
RESULTS = ROOT / "benchmarks" / "performance" / "results"
REPORT = ROOT / "reports" / "performance-results.md"


def load_analyzer():
    spec = importlib.util.spec_from_file_location("performance_analysis", ANALYZER)
...
class PerformanceCampaignAnalysisTest(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
