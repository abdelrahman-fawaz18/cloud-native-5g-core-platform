...
`cn5g_phase08_reviewed_*` gauges and the sixth **CN5G Reliability And
...
768 MiB limit. Final Phase 5 and Phase 6 regression validation passed before
the local-only post-Phase-8 host snapshot was captured.
