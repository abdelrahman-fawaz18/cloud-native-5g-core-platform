...
This decision is valid only when `scripts/phase10-lab.sh release-audit` passes
...
| Clean deployment | A different kind-node identity was created after reviewed deletion; Phases 4-6 installed from tracked lifecycle inputs and new local-path volumes |
...
| Local privileged gate | Phase 5/6 integration, image evidence, and the nine accepted Phase 7 plus nine accepted Phase 8 conditions were revalidated |
...
The fresh-cluster exercise exposed ignored Phase 5 and Phase 6 checkpoints
...
Reviewed Phase 7 throughput is controlled local experimental evidence, not a
capacity claim. Phase 8 restoration was operator-assisted and is not high
