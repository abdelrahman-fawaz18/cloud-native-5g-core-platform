...
Grafana. `scripts/generate-performance-dashboard-metrics.py` validates the reviewed
summary and produces 556 bounded `cn5g_performance_reviewed_*` gauges. A restricted
