# Reliability And Recovery Methodology

## Objective And Claim Boundary

Resilience campaign measures how the accepted local platform detects and recovers from one
...
[`benchmarks/resilience/experiment.json`](../../benchmarks/resilience/experiment.json).
...
```mermaid
flowchart LR
    B["Verified platform and observability baseline"] --> F["Delete one exact Pod"]
    ...
    O --> C
    C --> V["platform and observability stack validation"]
...
t7  platform and observability stack pass          complete baseline restoration
```
...
- baseline, repair, and restored platform and observability validation logs; and
